...
############# Actors ################
        ...
        movies.append(Movie(title = "Fifty Shades Freed", blurb = "Anastasia and Christian get married, but Jack Hyde continues to threaten their relationship.", cover = "img/MovieCovers/FiftyShadesFreed.jpg", rating = 4.2  ,duration = "105", director = "James Foley", certificate = "R", releaseDate = "2018-02-09"))
        ...
        movies.append(Movie(title = "Maze Runner: The Death Cure", blurb = "Young hero Thomas embarks on a mission to find a cure for a deadly disease known as the 'Flare'.", cover = "img/MovieCovers/MazeRunnerTheDeathCure.jpg", rating = 6.9  ,duration = "141", director = "Wes Ball", certificate = "13", releaseDate = "2018-01-26"))
        ...
        movies.append(Movie(title = "The Commuter", blurb = "A businessman is caught up in a criminal conspiracy during his daily commute home.", cover = "img/MovieCovers/TheCommuter.jpg", rating = 6.5  ,duration = "105", director = "Jaume Collet-Serra", certificate = "13", releaseDate = "2018-01-12"))
