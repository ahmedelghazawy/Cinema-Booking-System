...
class Command(BaseCommand):
	...
	help = "Populates the databse with relation to Today's date"
...
###################### Screenings ######################
		...
		# List to hold the screening objects
		screenings = []

		# Inserting data
		for screening in Screenings:
			screens = screening[1].split(",")
			for screen in screens:
				#print("Screening {} screen {}".format(screening[0],screen))
				screenings.append(Screening(movie_id = movies[int(screening[0])], screen_id = screens[int(screen)]))
...
############################ Timings ######################
	...
	def releaseDate(noOfDays):
		return today + datetime.timedelta(day=days)
